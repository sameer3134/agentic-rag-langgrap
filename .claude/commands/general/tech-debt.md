...
complexity: advanced
priority: medium
tags: ["review", "performance", "backend", "frontend"]
depends_on: []
chains_to: []
skip_if: []
version: 1.0.0
...
Annual Cost: 240 hours x $150/hour = $36,000
```
...
Metrics:
  ...
  code_duplication:
    ...
    duplication_hotspots:
      - {{PATH_SRC}}/validation: 850 lines
      - {{BE_PATH_API}}/handlers: 620 lines
...
3. Automate deployment script
   Effort: 12 hours
   Savings: 2 hours/deployment x 20 deploys/month
