...
complexity: advanced
priority: high
tags: [config, validation, backend, security]
depends_on: []
chains_to: [cloud/deploy-checklist]
skip_if: []
version: 1.0.0
---
...
// {{BE_TEST_FRAMEWORK}} test examples
