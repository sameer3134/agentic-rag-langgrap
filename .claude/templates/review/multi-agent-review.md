...
priority: high
tags: ["review", "performance", "frontend", "backend"]
depends_on: []
chains_to: []
skip_if: []
version: 1.0.0
...
Use Agent tool with subagent_type="code-reviewer" to examine:
...
### 2. Security Review
Use Agent tool with subagent_type="security-auditor" to check:
...
Use Agent tool with subagent_type="architect-reviewer" to evaluate:
